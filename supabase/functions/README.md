...
- `create-checkout-session` — generic membership checkout (admin/premium; also basic fallback).
- `create-basic-membership-checkout-session` — dedicated basic-membership checkout.
...
- `_shared/` — `stripe.ts` (Stripe + admin Supabase client, provisioning, CORS),
